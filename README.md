...
| AI | Claude 3.5 Haiku (default) | Language model integration |
...
### Code Quality
Code refinement is performed using the `code-simplifier` Claude Code subagent, which automates cleanup for clarity, consistency, and maintainability. See the [changelog](docs/CODE_SIMPLIFIER_CHANGELOG.md) for refinement history.
